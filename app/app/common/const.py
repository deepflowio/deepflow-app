...
TAP_SIDE_CLIENT_GATEWAY_HYPERVISOR = 'c-gw-hv'
TAP_SIDE_CLIENT_GATEWAY = 'c-gw'
TAP_SIDE_SERVER_GATEWAY = 's-gw'
TAP_SIDE_SERVER_GATEWAY_HYPERVISOR = 's-gw-hv'
...
SERVER_SIDE_TAP_SIDES = [
    TAP_SIDE_SERVER_GATEWAY, TAP_SIDE_SERVER_GATEWAY_HYPERVISOR,
...
REVERSE_TAP_SIDE = {
    ...
    TAP_SIDE_CLIENT_NIC: TAP_SIDE_SERVER_NIC,
    TAP_SIDE_CLIENT_POD_NODE: TAP_SIDE_SERVER_POD_NODE,
    TAP_SIDE_CLIENT_HYPERVISOR: TAP_SIDE_SERVER_HYPERVISOR,
    TAP_SIDE_CLIENT_GATEWAY_HYPERVISOR: TAP_SIDE_SERVER_GATEWAY_HYPERVISOR,
    TAP_SIDE_CLIENT_GATEWAY: TAP_SIDE_SERVER_GATEWAY,
    TAP_SIDE_SERVER_GATEWAY: TAP_SIDE_CLIENT_GATEWAY,
    TAP_SIDE_SERVER_GATEWAY_HYPERVISOR: TAP_SIDE_CLIENT_GATEWAY_HYPERVISOR,
    TAP_SIDE_SERVER_HYPERVISOR: TAP_SIDE_CLIENT_HYPERVISOR,
    TAP_SIDE_SERVER_POD_NODE: TAP_SIDE_CLIENT_POD_NODE,
    TAP_SIDE_SERVER_NIC: TAP_SIDE_CLIENT_NIC,
    TAP_SIDE_SERVER_PROCESS: TAP_SIDE_CLIENT_PROCESS,
    TAP_SIDE_SERVER_APP: TAP_SIDE_CLIENT_APP
}

AUTO_SERVICE_INTERNET_IP = 0
AUTO_SERVICE_IP = 255

AUTO_INSTANCE_INTERNET_IP = 0
AUTO_INSTANCE_CHOST = 1
AUTO_INSTANCE_POD = 10
AUTO_INSTANCE_POD_NODE = 14
AUTO_INSTANCE_IP = 255
